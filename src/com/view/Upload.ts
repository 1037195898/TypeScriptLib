...
export class Upload {
    ...
    static get inst(): Upload {
        if (this._instance == null) this._instance = new Upload
    ...
    private _syncInputTransform() {
        ...
        let style: any = this.nativeFile.style


        let transform: any = Utils.getTransformRelativeToWindow(this.target, 0, 0)
